...
public class HelloWorldButton : MonoBehaviour
{
    ...
    public async void OnClick2()
    {
        ...
        // var graphQLClient = new GraphQLHttpClient($"https://zrzxcskrlfcsxmvuusj2knj6iu.appsync-api.us-east-2.amazonaws.com/graphql?header={header}&payload=e30=", new NewtonsoftJsonSerializer());
        var graphQLClient = new GraphQLHttpClient($"https://zrzxcskrlfcsxmvuusj2knj6iu.appsync-realtime-api.us-east-2.amazonaws.com/graphql?header={header}&payload=e30=", new NewtonsoftJsonSerializer());
        // graphQLClient.HttpClient.DefaultRequestHeaders.Add("host", "zrzxcskrlfcsxmvuusj2knj6iu.appsync-api.us-east-2.amazonaws.com");
        // graphQLClient.HttpClient.DefaultRequestHeaders.Add("x-api-key", API_KEY);
        ...
        var subscriptionStream = graphQLClient.CreateSubscriptionStream<SubscriptionResponse>(request, ex =>
        {
            Debug.Log(ex);
        });
